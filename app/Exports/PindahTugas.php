...
class PindahTugas implements WithProperties, WithCustomStartCell, FromQuery, WithHeadings, WithMapping, WithColumnFormatting, ShouldAutoSize, WithEvents, WithColumnWidths
{
    ...
    public function registerEvents(): array
    {
        ...
        return [
            AfterSheet::class => function(AfterSheet $event) {
                ...
                $sheet->setCellValue('C5', ": Pindah Tugas");
                ...
                $sheet->setCellValue('C8', ": ".DataPendaftar::whereIdSekolah(\Auth::user()->sekolah->id)->whereIdJalur('7')->count());
