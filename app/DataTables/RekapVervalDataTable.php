...
class RekapVervalDataTable extends DataTable
{
    /**
            ...
            ->addColumn('action', function ($query) {
                $btn = '<div class="btn-group" role="group">
                                                ...
                                                <ul class="dropdown-menu" aria-labelledby="btnGroupDrop1" data-popper-placement="bottom-start">
                                                    <li><a class="dropdown-item" href="/verval/id/' . $query->nisn . '">Verval</a></li>
                                                </ul>
                                            </div>';
                return $btn;
            })
    ...
    {
        return $model->with(['users', 'sekolah', 'asal_sekolah','dapodik','jalur'])->where('id_sekolah', \Auth::user()->sekolah->id)
            ->where('verval', '=', '1')
            ->newQuery();
    }
    ...
    public function html(): HtmlBuilder
    {
        return $this->builder()
            ...
            ->setTableId('datarekappendaftar-table')
    ...
    {
        return 'RekapVerval_' . date('YmdHis');
    }
}
