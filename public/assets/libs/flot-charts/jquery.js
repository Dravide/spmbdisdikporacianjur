...
(function (window, undefined) {
        ...
        each: function (obj, callback, args) {
            ...
            if (args) {
                ...
                if (isObj) {
                    for (name in obj) {
                        if (
                            callback.call(obj[name], name, obj[name]) === false
                        ) {
                            break;
                        }
                    }
    ...
    jQuery.extend({
        ...
        data: function (elem, name, data, pvt /* Internal Use Only */) {
            ...
            if (!id) {
                ...
                if (isNode) {
                    elem[internalKey] = id =
                        jQuery.deletedIds.pop() || jQuery.guid++;
                } else {
                    id = internalKey;
                }
            }
    ...
    if (!getSetAttribute) {
        ...
        nodeHook = jQuery.valHooks.button = {
            get: function (elem, name) {
                ...
                return ret &&
                    (fixSpecified[name] ? ret.value !== "" : ret.specified)
                    ? ret.value
                    : undefined;
            },
            set: function (elem, value, name) {
                ...
                ATTR: function (name, operator, check) {
                    return function (elem, context) {
                        ...
                        return operator === "="
                            ...
                            : operator === "$="
                            ? check &&
                              result.substr(result.length - check.length) ===
                                  check
                            : operator === "~="
    ...
    jQuery.extend({
        ...
        clean: function (elems, context, fragment, scripts) {
            ...
            if (
                !context ||
                typeof context.createDocumentFragment === "undefined"
            ) {
                context = document;
            }
    ...
    function augmentWidthOrHeight(elem, name, extra, isBorderBox) {
        ...
        for (; i < 4; i += 2) {
            ...
            if (isBorderBox) {
                ...
                if (extra === "content") {
                    val -=
                        parseFloat(curCSS(elem, "padding" + cssExpand[i])) || 0;
                }
                ...
                if (extra !== "margin") {
                    val -=
                        parseFloat(
                            curCSS(elem, "border" + cssExpand[i] + "Width")
                        ) || 0;
                }
            } else {
    ...
    function css_defaultDisplay(nodeName) {
        ...
        if (display === "none" || display === "") {
            ...
            elem = iframeDoc.body.appendChild(
                iframeDoc.createElement(nodeName)
            );
                ...
                function (prop, value) {
                    ...
                    if (parts) {
                        ...
                        if (unit !== "px" && start) {
                            ...
                            start =
                                jQuery.css(tween.elem, prop, true) || end || 1;
