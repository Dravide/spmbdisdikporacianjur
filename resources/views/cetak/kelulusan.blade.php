...
{{--        </style>--}}
    ...
    <div class="card bg-soft-light mt-3">
        <div class="card-body text-center py-2">
            ...
            <b>PEMERINTAH KABUPATEN CIANJUR</b><br>DINAS PENDIDIKAN PEMUDA DAN OLAHRAGA<br><b>TAHUN 2023</b>
        </div>
    </div>
        ...
        <div class="card-body">
            ...
            <table>
                ...
                <tr class="small">
                    ...
                    <td width="10px">:</td>
                    <td>@if($data->jenis == 'luar')
                            {{ $datasiswa['tempat_lahir'] }}
                            , {{ Carbon::createFromFormat('Y-m-d', $datasiswa['tanggal_lahir'])->format('d F Y') }}
                        @else
                            {{ $datasiswa['tempat_lahir'] }}
                            , {{ Carbon::createFromFormat('d/m/Y', $datasiswa['tanggal_lahir'])->format('d F Y') }}
                        @endif
                    </td>
                </tr>
                <tr class="small">
                ...
                <tr class="small">
                    <td width="200px"></td>
                    <td width="10px"></td>
                    <td>RT {{ $datasiswa['rt'] }} / {{ $datasiswa['rw'] }}, Desa {{ $datasiswa['desa'] }},
                        Dusun {{ $datasiswa['dusun'] }}</td>
                </tr>
                <tr class="small">
                    <td width="200px">Asal Sekolah</td>
                    <td width="10px">:</td>
                    <td><b>
                            @if($data->id_sekolah_asals == null)
                                {{ $datasiswa['nama_asal_sekolah'] }}
                            @else
                                {{ $data->asal_sekolah->nama_sekolah}}
                            @endif</b>
                ...
                <tr class="small">
                    <td style="width: fit-content">
                        <ol>
                            ...
                            <li>Surat Edaran Kementrian Pendidikan Kebudayaan Riset dan Teknologi Nomor:7978/
                            ...
                            <li>
                            <li>Petunjuk Teknis dari Disdikpora Kabupaten Cianjur No: : 420/666/Disdikpora/Kab/2023
                                tanggal 26 Mei Tahun 2023 Tentang Pedoman Pelaksanaan Penerimaan Peserta Didik Baru Pada
            ...
            <table>
                ...
                <tr class="small">
                    <td width="450px"></td>
                    <td>Cianjur, {{ Carbon::now()->format('d') }} Juni 2023
                        <br>
                        <br>
                        <br>
                        <i class="small">Materai (10000)</i>
                        <br>
                        <br>
                        <br>
