        ...
        <div class="card-body">
            ...
            <table>
                ...
                <tr class="small">
                    ...
                    <td width="10px">:</td>
                    <td>RIFQI MAULANA ADAM</td>
                </tr>
                <tr class="small">
                    <td width="200px">NIK</td>
                    <td width="10px">:</td>
                    <td>3203283774628884</td>
                </tr>
                <tr class="small">
                ...
                <tr class="small">
                    ...
                    <td width="10px">:</td>
                    <td>CIANJUR, 10 JULI 2011
                    </td>
                </tr>
                <tr class="small">
                    <td width="200px">Alamat</td>
                    <td width="10px">:</td>
                    <td>KP. CIPEUTEUY RT 02 RW 04 DESA SUKAMULYA BOGOR}</td>
                </tr>
                <tr class="small">
                    <td width="200px"></td>
                    <td width="10px"></td>
                    <td>RT 02 RW 04 DESA SUKAMULYA BOGOR}</td>
                </tr>
                <tr class="small">
                    <td width="200px">Asal Sekolah</td>
                    <td width="10px">:</td>
                    <td><b>
                           SD NEGERI CIHERANG 4</b>
                ...
                <tr class="small">
                    ...
                    <td width="10px">:</td>
                    <td><b>SMP NEGERI 1 CIPANAS</b></td>
                </tr>
                </tbody>
            </table>
