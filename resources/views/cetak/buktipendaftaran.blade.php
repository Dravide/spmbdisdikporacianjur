...
<div class="card bg-soft-success mb-0">
    <div class="card-body text-center py-2">
        <b>TANDA BUKTI PENDAFTARAN SPMB TINGKAT SMP</b><br/>
...
<div class="card mt-0">
    <div class="card-body">
        ...
        <hr class="new2">
        <p class="text-center my-2 small">Berdasarkan Hasil Verifikkasi dan Validasi Data dan Berkas oleh Operator
            <b>{{ $data->sekolah->nama_sekolah }}</b>
            Siswa
            dengan Nomor Peserta {{ $data->users->username }} (<b>{{ $data->dapodik->nama }}</b>) dinyatakan :<br>
        </p>
        <p class="text-center bg-soft-primary rounded-2 py-2"><b>Telah Lolos Validasi dan Verifikasi</b></p>
        <div class="text-center py-2"><img src="assets/images/verified.png" height="100"
                                           alt="logoppdb"/>
        </div>
    </div>
    <footer>
