...
{{--        </style>--}}
    ...
    <div class="card bg-soft-info mb-0">
        <div class="card-body text-center py-2">
            <b>SURAT PERNYATAAN KEBENARAN DOKUMEN PERSYARATAN <br>SISTEM PENERIMAAN MURID BARU TINGKAT SMP</b><br/>
            DINAS PENDIDIKAN PEMUDA DAN OLAHRAGA KABUPATEN CIANJUR<br/>
            TAHUN PELAJARAN 2024/2025
        </div>
    </div>
    <div class="card mt-0">
        <div class="card-body">
            <p class="small">Yang bertanda tangan di bawah ini Orang Tua / Wali dari :</p>
            <table>
                <tbody>
                <tr class="small">
                ...
                <tr class="small">
                    <td width="200px"></td>
                    <td width="10px"></td>
                    <td>RT {{ $data->dapodik['rt'] }} / {{ $data->dapodik['rw'] }},
                        Desa {{ $data->dapodik['desa_kelurahan'] }},
            ...
            <p class="text-center my-2"><b>MENYATAKAN</b></p>
            <table>
                <tbody>
                <tr class="small">
                    <td style="width: fit-content">
                        <ol>
                            <li>Bahwa Data dan Berkas anak Saya (<b>{{ $data->dapodik['nama'] }}</b>) yang di Unggah
                                pada
                                Jalur
                                <b>{{ $data->jalur->nama_jalur }}</b>
                                adalah data
                                yang sebenarnya dan dapat dipertanggungjawabkan;
                            </li>
                            <li>Jika di kemudian hari ditemukan terdapat manipulasi data, saya sebagai Orang Tua/Wali
                                siap
                                mendapat sanksi
                                dengan dibatalkannya pendaftaran ke <b>{{ $data->sekolah->nama_sekolah }}</b>
                            </li>
                        </ol>
                    </td>
                </tr>
            ...
            <table>
                ...
                <tr class="small">
                    <td width="400px"></td>
                    <td>Cianjur, {{ Carbon::now()->format('d') }} Juni 2025
                        <br>
                        <br>
                        <br>
