<div class="col-xl-3 mb-0 mb-xl-0">
    <div class="card">
        <div class="card-body">
            <h4 class="mt-1 mb-3">Menu Utama</h4>
            <div
            ...
            <div
                class="mail-list my-2 px-2 bg-soft-{{ request()->routeIs('Pendaftaran.datapeserta') ? 'light' : 'danger' }} rounded-3"
                data-bs-toggle="tooltip"
                data-bs-placement="right"
                title=""
                   ...
                   class="text-body d-block">
                    <div class="d-flex py-1">
                        <div class="flex-shrink-0 me-3 align-self-center">
                            <div class="avatar-xs">
                                                                <span
                                                                    class="avatar-title bg-soft-danger rounded-circle text-danger">
            ...
            <div
                class="mail-list my-2 px-2 bg-soft-{{ request()->routeIs('sekolah-tujuan.index') ? 'light' : 'success' }} rounded-3"
                data-bs-toggle="tooltip"
                   ...
                   class="text-body d-block">
                    <div class="d-flex py-1">
                        <div class="flex-shrink-0 me-3 align-self-center">
                            <div class="avatar-xs">
                                                        <span
                                                            class="avatar-title bg-soft-success rounded-circle text-success">
            ...
            <div
                class="mail-list my-2 px-2 bg-soft-{{ request()->routeIs('pendaftaran.berkasumum') ? 'light' : 'warning' }} rounded-3"
                data-bs-toggle="tooltip"
                data-bs-placement="right" title=""
                   ...
                   class="text-body d-block">
                    <div class="d-flex py-1">
                        <div class="flex-shrink-0 me-3 align-self-center">
                            <div class="avatar-xs">
                                                        <span
                                                            class="avatar-title bg-soft-warning rounded-circle text-warning">
            ...
            <div
                class="mail-list my-2 px-2 bg-soft-{{ request()->routeIs('Pendaftaran.berkaskhusus') ? 'light' : 'info' }} rounded-3"
                data-bs-toggle="tooltip"
                data-bs-placement="right" title=""
                   ...
                   class="text-body d-block ">
                    <div class="d-flex py-1">
                        <div class="flex-shrink-0 me-3 align-self-center">
                            <div class="avatar-xs">
                                                        <span
                                                            class="avatar-title bg-soft-info rounded-circle text-info">
